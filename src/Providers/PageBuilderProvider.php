		...
		return [
			'carousel' => [
				...
				'configSchema' => [
					...
					['key' => 'showDots', 'type' => 'checkbox', 'label' => 'Mostra punti', 'default' => false],
					['key' => 'dotsMode', 'type' => 'select', 'label' => 'Punti per', 'default' => 'page',
						'when' => fn($c) => !empty($c['showDots']),
						'options' => [
							['value' => 'page', 'label' => 'Pagina'],
							['value' => 'slide', 'label' => 'Slide'],
						]],
					['key' => 'dotsColor', 'type' => 'color', 'label' => 'Colore punti', 'default' => '#0d6efd',
						'when' => fn($c) => !empty($c['showDots'])],
				],
